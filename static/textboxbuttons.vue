  ...
  <b-field grouped group-multiline>
    ...
    <p class="control">
      <b-button size="is-small" type="is-light" :disabled="buttonsDisabled" @click="getMovieList">
        <i class="fas fa-discord"></i>&nbsp;{{ $t('textboxbuttons.Load from Clumsy Movie Bot') }}
      </b-button>
    </p>
    <p class="control">
      <b-checkbox size="is-small" :disabled="buttonsDisabled" v-if="displayAdvancedCheckbox" v-model="wheelIsAdvanced"
